...
describe StaleIfSlow do
  ...
  describe "#configure" do
    ...
    it "should set the configurations on config object through a hash" do
      StaleIfSlow.configure({
    ...
    it "should set the configurations on config object through a block" do
